...
void php_raylib_texture_startup(INIT_FUNC_ARGS)
{
    ...
    // Filters
    REGISTER_RAYLIB_TEXTURE_CLASS_CONST_LONG("FILTER_POINT", TEXTURE_FILTER_POINT);
    REGISTER_RAYLIB_TEXTURE_CLASS_CONST_LONG("FILTER_BILINEAR", TEXTURE_FILTER_BILINEAR);
    REGISTER_RAYLIB_TEXTURE_CLASS_CONST_LONG("FILTER_TRILINEAR", TEXTURE_FILTER_TRILINEAR);
    REGISTER_RAYLIB_TEXTURE_CLASS_CONST_LONG("FILTER_ANISOTROPIC_4X", TEXTURE_FILTER_ANISOTROPIC_4X);
    REGISTER_RAYLIB_TEXTURE_CLASS_CONST_LONG("FILTER_ANISOTROPIC_8X", TEXTURE_FILTER_ANISOTROPIC_8X);
    REGISTER_RAYLIB_TEXTURE_CLASS_CONST_LONG("FILTER_ANISOTROPIC_16X", TEXTURE_FILTER_ANISOTROPIC_16X);

    // Wraps
    REGISTER_RAYLIB_TEXTURE_CLASS_CONST_LONG("WRAP_REPEAT", TEXTURE_WRAP_REPEAT);
    REGISTER_RAYLIB_TEXTURE_CLASS_CONST_LONG("WRAP_CLAMP", TEXTURE_WRAP_CLAMP);
    REGISTER_RAYLIB_TEXTURE_CLASS_CONST_LONG("WRAP_MIRROR_REPEAT", TEXTURE_WRAP_MIRROR_REPEAT);
    REGISTER_RAYLIB_TEXTURE_CLASS_CONST_LONG("WRAP_MIRROR_CLAMP", TEXTURE_WRAP_MIRROR_CLAMP);
}