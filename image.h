...
extern void php_raylib_image_update_intern(php_raylib_image_object *intern);
extern void php_raylib_image_update_intern_reverse(php_raylib_image_object *intern);
