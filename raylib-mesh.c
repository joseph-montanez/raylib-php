...
//            .vertices = other->mesh.vertices,
//            .texcoords = other->mesh.texcoords,
//            .texcoords2 = other->mesh.texcoords2,
//            .normals = other->mesh.normals,
//            .tangents = other->mesh.tangents,
//            .colors = other->mesh.colors,
//            .indices = other->mesh.indices,
//            .animVertices = other->mesh.animVertices,
//            .animNormals = other->mesh.animNormals,
//            .boneIds = other->mesh.boneIds,
//            .boneWeights = other->mesh.boneWeights,
            .vaoId = other->mesh.vaoId,
//            .vboId = other->mesh.vboId
        };
    } else {
        intern->mesh = (Mesh) {
            .vertexCount = 0,
