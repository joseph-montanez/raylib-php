...
static void php_raylib_vrstereoconfig_update_intern(php_raylib_vrstereoconfig_object *intern) {
    ...
    intern->vrstereoconfig.viewOffset[1] = intern->viewoffset[1].matrix;
}
...
//            .leftLensCenter = other->vrstereoconfig.leftLensCenter,
//            .rightLensCenter = other->vrstereoconfig.rightLensCenter,
//            .leftScreenCenter = other->vrstereoconfig.leftScreenCenter,
//            .rightScreenCenter = other->vrstereoconfig.rightScreenCenter,
//            .scale = other->vrstereoconfig.scale,
//            .scaleIn = other->vrstereoconfig.scaleIn
        };
