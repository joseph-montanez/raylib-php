...
/* {{{ php_raylib_camera2d_write_property(zend_object *object, zend_string *member, zval *value, void **cache_slot)
   Generic object property writer */
zval *php_raylib_camera2d_write_property(zend_object *object, zend_string *member, zval *value, void **cache_slot)
{
    php_raylib_camera2d_object *obj;
    raylib_camera2d_prop_handler *hnd;
...
static zend_object * php_raylib_camera2d_offset(php_raylib_camera2d_object *obj) /* {{{ */
{
...
static zend_object * php_raylib_camera2d_target(php_raylib_camera2d_object *obj) /* {{{ */
{
...
static double php_raylib_camera2d_rotation(php_raylib_camera2d_object *obj) /* {{{ */
{
    return (double) obj->camera2d.rotation;
}
/* }}} */

static double php_raylib_camera2d_zoom(php_raylib_camera2d_object *obj) /* {{{ */
{
    return (double) obj->camera2d.zoom;
}
/* }}} */

static int php_raylib_camera2d_write_offset(php_raylib_camera2d_object *camera2d_object, zval *newval) /* {{{ */
{
    int ret = SUCCESS;
    ...
    camera2d_object->offset = phpOffset;

    return ret;
}
/* }}} */

static int php_raylib_camera2d_write_target(php_raylib_camera2d_object *ray_object, zval *newval) /* {{{ */
{
    int ret = SUCCESS;
...
static int php_raylib_camera2d_write_rotation(php_raylib_camera2d_object *camera2d_object, zval *newval) /* {{{ */
{
    int ret = SUCCESS;

    if (Z_TYPE_P(newval) == IS_NULL) {
        camera2d_object->camera2d.rotation = 0;
        return ret;
    }

    camera2d_object->camera2d.rotation = (float) zval_get_double(newval);

    return ret;
}
/* }}} */

static int php_raylib_camera2d_write_zoom(php_raylib_camera2d_object *camera2d_object, zval *newval) /* {{{ */
{
    int ret = SUCCESS;

    if (Z_TYPE_P(newval) == IS_NULL) {
        camera2d_object->camera2d.zoom = 0;
        return ret;
    }

    camera2d_object->camera2d.zoom = (float) zval_get_double(newval);
...
ZEND_BEGIN_ARG_INFO_EX(arginfo_camera2d_getOffset, 0, 0, 0)
ZEND_END_ARG_INFO()
PHP_METHOD(Camera2d, getOffset)
{
    php_raylib_camera2d_object *intern = Z_CAMERA2D_OBJ_P(ZEND_THIS);

    RETURN_OBJ(&intern->offset->std);
}


ZEND_BEGIN_ARG_INFO_EX(arginfo_camera2d_setOffset, 0, 0, 1)
    ZEND_ARG_INFO(0, offset)
ZEND_END_ARG_INFO()
...
ZEND_BEGIN_ARG_INFO_EX(arginfo_camera2d_getTarget, 0, 0, 0)
ZEND_END_ARG_INFO()
...
ZEND_BEGIN_ARG_INFO_EX(arginfo_camera2d_setTarget, 0, 0, 1)
    ZEND_ARG_INFO(0, target)
ZEND_END_ARG_INFO()
...
ZEND_BEGIN_ARG_INFO_EX(arginfo_camera2d_getRotation, 0, 0, 0)
ZEND_END_ARG_INFO()
...
ZEND_BEGIN_ARG_INFO_EX(arginfo_camera2d_setRotation, 0, 0, 1)
    ZEND_ARG_INFO(0, rotation)
ZEND_END_ARG_INFO()
...
ZEND_BEGIN_ARG_INFO_EX(arginfo_camera2d_getZoom, 0, 0, 0)
ZEND_END_ARG_INFO()
...
ZEND_BEGIN_ARG_INFO_EX(arginfo_camera2d_setZoom, 0, 0, 1)
    ZEND_ARG_INFO(0, zoom)
ZEND_END_ARG_INFO()
...
const zend_function_entry php_raylib_camera2d_methods[] = {
        ...
        PHP_ME(Camera2d, setOffset, arginfo_camera2d_setOffset, ZEND_ACC_PUBLIC)
        PHP_ME(Camera2d, getTarget, arginfo_camera2d_getTarget, ZEND_ACC_PUBLIC)
        PHP_ME(Camera2d, setTarget, arginfo_camera2d_setTarget, ZEND_ACC_PUBLIC)
        PHP_ME(Camera2d, getRotation, arginfo_camera2d_getRotation, ZEND_ACC_PUBLIC)
...
void php_raylib_camera2d_startup(INIT_FUNC_ARGS)
{
    ...
    php_raylib_camera2d_register_prop_handler(&php_raylib_camera2d_prop_handlers, "offset", NULL, NULL, php_raylib_camera2d_offset, php_raylib_camera2d_write_offset);
    php_raylib_camera2d_register_prop_handler(&php_raylib_camera2d_prop_handlers, "target", NULL, NULL, php_raylib_camera2d_target, php_raylib_camera2d_write_target);
    php_raylib_camera2d_register_prop_handler(&php_raylib_camera2d_prop_handlers, "rotation", php_raylib_camera2d_rotation, php_raylib_camera2d_write_rotation, NULL, NULL);
    php_raylib_camera2d_register_prop_handler(&php_raylib_camera2d_prop_handlers, "zoom", php_raylib_camera2d_zoom, php_raylib_camera2d_write_zoom, NULL, NULL);
}